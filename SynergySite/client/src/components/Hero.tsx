      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto" data-testid="text-hero-description">
            At V NEXT Synergy Solutions, we help businesses build efficiency, accuracy, and growth through our comprehensive People, Product, and Process Assurance Services.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-primary-foreground border border-primary/20 backdrop-blur-sm"
