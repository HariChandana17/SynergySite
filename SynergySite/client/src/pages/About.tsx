        ...
        <section className="py-24 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6" data-testid="text-about-title">
              About V NEXT Synergy Solutions
            </h1>
            <p className="text-xl md:text-2xl text-primary-foreground/80 max-w-4xl mx-auto" data-testid="text-about-intro">
              At V NEXT Synergy Solutions, we help businesses build efficiency, accuracy, and growth. We are a passionate team of professionals providing People, Product, and Process Assurance Services for enterprises across industries.
            </p>
          </div>
        </section>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto" data-testid="text-cta-description">
              Let's discuss how V NEXT Synergy Solutions can help optimize your business operations and drive sustainable growth.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                onClick={() => console.log('Learn About Services clicked')}
              >
